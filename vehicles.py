def main():
    ...
    if vin in  vehicles_dict:
        ...
        vehicle_data_needed = vehicles_dict[vin]

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f"Manufacturer: {vehicle_data_needed[MANUFACTURER_INDEX]}")
        print(f"Model: {vehicle_data_needed[MODEL_INDEX]}")
        print(f"Color: {vehicle_data_needed[COLOR_INDEX]}")
